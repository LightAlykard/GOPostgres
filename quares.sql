...
SELECT user_name, build_name, xCoord,yCoord FROM users, bildings, maps WHERE maps.user_id = users.id_user and maps.bilding_id=bildings.id_bild and user_name='tUser23';
